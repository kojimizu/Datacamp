...
Our five-factor `EFA` model `f_bfi_varimax` seems to reflect the expected factor structure nicely, since items of the same pre-defined putative factor on the left are almost identified with a factor 
